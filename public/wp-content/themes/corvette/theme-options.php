...
function corvette_customizer_config() {
...
add_filter( 'kirki/config', 'corvette_customizer_config' );


Kirki::add_config( 'corvette', array(
...
Kirki::add_panel( 'typography', array(
    'priority'    => 10,
    'title'       => __( 'Typography', 'corvette' ),
    'description' => __( 'This panel will provide all the fonts for your website.', 'corvette' ),
) );
...
Kirki::add_section( 'title_section', array(
    'title'          => __( 'Website Fonts, Colors, Style' , 'corvette'),
    'description'    => __( 'You can change Website fonts, colors, typography from here.', 'corvette' ),
...
Kirki::add_field( 'my_custom_text', array(
    ...
    'type'     => 'custom',
    'default'  => __( 'This is only available in Premium Version. <br/><a target="_blank" href="http://www.vinethemes.com/downloads/corvette-multipurpose-wordpress-theme/"> + Upgrade to Premium Version</a>', 'corvette' ),
) );
